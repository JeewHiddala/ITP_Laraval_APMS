...
<img src="{{ asset('images/logo.png') }}" alt="logo" width="110" height="100" style="float:left; margin-top:-2.2% ;padding-left:0.5%">
	...
	<li class="nav-item">
		<a class="nav-link active {{request () -> is('/dynamicEmp_pdf') ? 'active' : null }}"  href="{{url('/dynamicEmp_pdf')}}" role="tab">Employee Registration Reports</a>
	</li>
	<li class="nav-item">
		<a class="nav-link  {{request () -> is('/dynamicLeave_pdf') ? 'active' : null }}" href="{{url('/dynamicLeave_pdf')}}" role="tab">Leave Application Report</a>
	</li>
    <li class="nav-item">
		<a class="nav-link  {{request () -> is('/dynamicShortLeave_pdf') ? 'active' : null }}" href="{{url('/dynamicShortLeave_pdf')}}" role="tab">Short Leave Application Report</a>
	</li>
...
<div class="tab-content">
    ...
    <div class="tab-pane {{request() ->is('/dynamicShortLeave_pdf') ? 'active' : null }}" id="{{url('/dynamicShortLeave_pdf')}}" role="tabpanel">
		<p>ShortLeave Application</p>
            ...
            <h3 align="center">Ranjith Motors Employee Registration Information Report
            </h3><br /> 

            <div class="row">
                <div claa="col-md-7" align="right">&nbsp;&nbsp;&nbsp;&nbsp;
                    <h4 align="center">Employee Registration Information</h4>
                </div>
                <div class="col-md-12" align="right">
                <a href="{{ url('dynamicEmp_pdf/pdf') }}" class="btn btn-danger" >Genarate Registration Information Report In PDF</a>
                </div>
            </div>
            <br />
            <div class="table-responsive">
                ...
                table-bordered">
                    ...
                    $employee)
                        ...
                        <td>{{ $employee->nic}}</td>
                        <td><a href="/dynamicSingleEmp_pdf/{{$employee->employee_id}}" class="btn btn-success">Profile Report</a></td>
                        </tr>
                    @endforeach
                    </tbody>
                    </table>
  ...
  &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
        &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
        <a href="/emp" class="btn btn-primary">Go Back</a></br></br>
