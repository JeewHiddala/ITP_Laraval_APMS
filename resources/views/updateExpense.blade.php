...
<body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ">
              ...
              <li class="nav-item px-lg-4">
                <a class="nav-link text-uppercase text-expanded" href="products.html">Charts</a>
              </li>
              <li class="nav-item px-lg-4">
    ...
    <div class="container-lg pt-5">
        <h1>Update Your Expenses Here!</h1>
        <form action="/updateExpense" method="POST">
            {{csrf_field()}} <!--protect from cross site request forger attacks-->
        <div class="form-group">
            <input type="hidden" name="id" value="{{$expData->id}}"/>
            <p>Payment Number</p>
            <input type="text" name="paymentNumber" class="form-control" value="{{$expData->payment_number}}"/> <br>
            <p>Amount</p>
            <input type="text" name="amount" class="form-control" value="{{$expData->amount}}"/> <br>
            <p>Discount Received</p>
            <input type="text" name="discount" class="form-control" value="{{$expData->discount_received}}" placeholder="Add discount"/> <br>
            <p>Description</p>
            <input type="text" name="description" class="form-control" value="{{$expData->description}}" placeholder="Add description"/> <br>
            <p>Category</p>
            <select name="category" class="form-control">
                <option value="{{$expData->category}}">{{$expData->category}}</option>
            ...
            <input type="date" name="dot" class="form-control" value="{{$expData->date_of_transaction}}"/>
            <br>
            <input type="submit" class="btn btn-warning" value="Update">
            &nbsp; <!--horizontal spacing-->
            <a href="/expense" class="btn btn-danger">Cancel</a>
        </div>
        </form>
    </div>  
