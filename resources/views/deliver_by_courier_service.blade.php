...
<head>
    ...
    <title>Delivery | Courier Services</title>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ">
              ...
              <li class="nav-item px-lg-4">
                <a class="nav-link text-uppercase text-expanded" href="/RCourier">Report</a>
              </li>
        ...
        <div class="col-md-2.5 float-right">
            ...
            <div class="container">
                        <div class="form-group">
                            ...
                            <form method="post" action="/save_delivery2">
                            {{csrf_field()}}
                            <p>Select Invoice:</p>
                            ...
                            <p>Select Courier Service:</p>&nbsp;&nbsp;&nbsp;&nbsp; 

                            <select name="courier_id" class="courier form-control" style="width:50px" id="courier_id">
                                <option value="courier">--- Select Courier Service ---</option>
                            ...
                            <input type="date" class = "date form-control" name="date" style="width:50px" placeholder = ""/><br>

                            &nbsp;&nbsp;&nbsp;&nbsp; <p style="text-align:left">Total Cost</p>&nbsp;&nbsp;&nbsp;&nbsp; 
                            <input type="number" class = "date form-control" name="total" style="width:50px" placeholder = ""/><br></div><br>
                            ...
                            <table class="table table-dark">
                                ...
                                <tr>
                                    ...
                                    <td><a href="/deldelivery2/{{$datas->id}}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
