...
<head>
    ...
    <title>GoodReturn Invoice</title>
</head>
<body>
    ...
    <form action="/search" method ="get">
        <div class="form-group">
             ...
             <input type="search" class = "form-control" name="search" placeholder = "Enter Invoice No" required/>
        ...
        <br>
          ...
          <input type="submit" class="btn btn-success" name="gdbill" value="Check">
