...
<body>
            ...
            <table class="table table-dark">
              <tr>
                ...
                <tr>
                    ...
                    <td><a href="/editvehicle/{{$data->id}}" class="btn btn-success">Update</a></td>
                    <td><a href="/deletevehicle/{{$data->id}}" class="btn btn-danger" onclick="return confirm('Are you sure want to delete?')">Delete</a></td>
    ...
    <div>
      <a href="/vehicleregistration" class="btn btn-primary" style = "float:left">Back</a>
     </div>
    </div>
</div>
</div>
