...
<div class="container"> 
        ...
        <h1>Short Leave Application Form</h1>

        <div class="container">
    <ul class="nav nav-tabs" role="tablist">
	<li class="nav-item">
		<a class="nav-link  {{request () -> is('/leave') ? 'active' : null }}"  href="{{url('/leave')}}" role="tab">Apply For A leave</a>
	</li>
	<li class="nav-item">
		<a class="nav-link active {{request () -> is('/sleave') ? 'active' : null }}" href="{{url('/sleave')}}" role="tab">Apply For A Short Leave</a>
	</li>
...
<div class="tab-content">
  ...
  <br><br>
        ...
        <div class="row">
                ...
                <form method="post" action="/storeShortLeave">
                {{csrf_field()}}
                <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                Employee ID &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                <input type="text" pattern="[0-9]{2,}" required="" class="form-control" name="empIDs" placeholder="Enter Employee ID">
            </div></br>
            
            <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                Employee Name &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                <input type="text" class="form-control" name="empNames" placeholder="Enter Employee Name">
            </div></br>

            <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                Reason for the short leave  &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                <input type="text" class="form-control" name="reasons" placeholder="Enter the reason">
            </div></br>

            <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                Date &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                <input type="text" pattern="(?=.\d)(?=.[0-9]).{10}" required="" class="form-control" name="dates" placeholder=" 0000-00-00">
            </div></br>

            <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                Time Duration From &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                <input type="text" pattern="(?=.\d)(?=.[0-9]).{5}" required="" class="form-control" name="froms" placeholder="00:00">

                &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="text" pattern="(?=.\d)(?=.[0-9]).{5}" required="" class="form-control" name="tos" placeholder="00:00">
            </div></br>
            ...
            <input type="submit" class="btn btn-primary" value="SEND TO APPROVAL">
                ...
                <table class="table table-dark">
                    ...
                    @foreach($shortLeaveForm as $formS)
                    <tr>
