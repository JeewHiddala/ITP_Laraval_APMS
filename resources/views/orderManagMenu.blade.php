...
<head>
    ...
    <title>Order Management for wholeSale Buyers</title>
...
<img src="images/logo.png" alt="logo" width="110" height="100" style="float:left; margin-top:-2.2% ;padding-left:0.5%">
    ...
    <div class="container-lg pt-5">
        <h1>Order Management for WholeSaleBuyers</h1>
        <br>
        <br>
    </div>
        ...
        <div class="card-deck">
            <div class="card" style="width:400px;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Place an Order for wholeSale Buyers</p>
                    <a href="/wsbuyer" class="btn btn-primary">Enter</a>
                </div>
            </div>
