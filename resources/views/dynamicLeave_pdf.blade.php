...
<img src="{{ asset('images/logo.png') }}" alt="logo" width="110" height="100" style="float:left; margin-top:-2.2% ;padding-left:0.5%">
	...
	<li class="nav-item">
		<a class="nav-link active {{request () -> is('/dynamicLeave_pdf') ? 'active' : null }}" href="{{url('/dynamicLeave_pdf')}}" role="tab">Leave Application Report</a>
	</li>
    <li class="nav-item">
...
<div class="tab-content">
    ...
    <div class="tab-pane {{request() ->is('/dynamicShortLeave_pdf') ? 'active' : null }}" id="{{url('/dynamicShortLeave_pdf')}}" role="tabpanel">
		<p>ShortLeave Application</p>
            ...
            <h3 align="center">Ranjith Motors Employee leave Application Details Report
            </h3><br /> <br/>

            <div class="row">
                <div claa="col-md-7" align="right">
                    <h4 align="center">Employee Leave Application Report</h4>
                </div>
                <div class="col-md-8" align="right">
                <a href="{{ url('dynamicLeave_pdf/pdf') }}" class="btn btn-danger" >Genarate Leave Application Report In PDF</a>
                </div>
            </div>
            <br />
  ...
  &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
        &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
        <a href="/approval" class="btn btn-primary">Back</a></br></br>
