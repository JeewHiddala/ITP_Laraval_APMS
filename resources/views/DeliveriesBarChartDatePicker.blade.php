...
<head>
    ...
    <title>Chart | Delivery | Bar</title>
...
<div class="container-lg pt-5">
    <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
          <a class="nav-link   {{request() -> is('/deliveries_pie_chart') ? 'active' : null }}" href="{{url('/deliveries_pie_chart')}}"
            role="tab">Pie Charts</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active {{request () -> is('/deliveries_bar_chart') ? 'active' : null }}" href="{{url('/deliveries_bar_chart')}}"
    ...
    <div class="container">
      <h4><b>Select date range</b></h4><br>
        <form method="GET" action="/DeliveryBarChart">
