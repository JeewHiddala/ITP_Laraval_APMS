...
<head>
    ...
    <title>Goods Return Pie Charts</title>
...
<div class="container-lg pt-5">
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link active {{request () -> is('/goodsReturnCharts') ? 'active' : null }}" href="{{url('/goodsReturnCharts')}}"
    ...
    <div class="container p-5">
        <h3>Pie Chart for Return Goods</h3>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var data = google.visualization.arrayToDataTable([
                ['GRE No', 'Recturn Quantity'],

                @php
                    foreach($goodsReturns as $goodsReturn) {
                        echo "['".$goodsReturn->gre_no."', ".$goodsReturn->return_quantity."],";
                    }
                @endphp
            ]);
    ...
    <br>
    <a href="/goodsReturnCharts" class="btn btn-primary">Back</a>
    <br><br><br>
</div>
<!--Footer-->
