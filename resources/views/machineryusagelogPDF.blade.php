...
<!--Tab Pane-->
    <div class="container">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link   {{request () -> is('/machinerymaintainancePDF') ? 'active' : null }}" href="{{url('/machinerymaintainancePDF')}}" role="tab">Machinery Maintenance Report</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active {{request () -> is('/machineryusagelogPDF') ? 'active' : null }}" href="{{url('/machineryusagelogPDF')}}" role="tab">Machinery Usage Log Report</a>
            </li>
...
<div class="container">
  <h4>Select date range</h4><br>
        <form method="GET" action="/machineryusagedatepicker">
...
<div class="container">
    <div class="form-group">
      ...
      <div><a href = "/machineryusagelogPDF/pdf/{{$from_date}}/{{$to_date}}"  class ="btn btn-danger"   style = "float:right">Convert in to PDF</a> </div><br>
      <p>For the period starting from <b><i>{{$from_date}}</i></b> to <b><i>{{$to_date}}</b></i></p>
        ...
        <thead>
            ...
            <tr  id = "table">
                ...
                <td>{{$datas->estimated_end_date}}</td>
                <td>{{$datas->estimated_end_time}}</td>
            </tr>
            @endforeach
          </thead>
          <tbody></tbody>
