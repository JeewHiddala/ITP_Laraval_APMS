...
<div class="container-lg pt-5">
    <ul class="nav nav-tabs" role="tablist">
      <li class="nav-item">
        <a class="nav-link {{request() -> is('/expenseSummary') ? 'active' : null }}" href="{{url('/expenseSummary')}}"
        ...
        <li class="nav-item">
          <a class="nav-link active {{request () -> is('/profitSummary') ? 'active' : null }}" href="{{url('/profitSummary')}}"
    ...
    <br>
        ...
        <form method="GET" action="/profitSummary">
...
<div class="container-lg pt-5">
    ...
    <a class="btn btn-danger" style="float:right;" href="/profitPDF/{{$fromDate}}/{{$toDate}}" target="_blank">Convert to PDF</a>
    <br>
    <br>
    <table class="table table-dark">
        <tr>
            <td>Total Sales from the Whole Sales </td>
            <td>LKR. {{$totalWholeSale}}.00</td>
        </tr>
        <tr>
            <td>Total Sales from the Individual Customers </td>
            <td>LKR. {{$totalIndividualSale}}</td>
        </tr>
        <tr>
            <td>Total Income other than Sales </td>
            <td>LKR. {{$totalIncome}}.00</td>
        </tr>
        <tr>
            <td>Total Income </td>
            <td>LKR. {{$totalSales}}.00</td>
        </tr>
        <tr>
            <td>Total Expenses </td>
            <td>LKR. {{$totalExpense}}.00</td>
        </tr>
        <tr>
            <td>Gross Profit for the Period </td>
            <td>LKR. {{$profit}}.00</td>
        </tr>
    </table>
