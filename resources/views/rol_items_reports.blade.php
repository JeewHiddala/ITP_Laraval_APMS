...
<div class="container-lg pt-5">
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link active {{request () -> is('/reorderItems/reports') ? 'active' : null }}" href="{{url('/reorderItems/reports')}}"
...
<div class="container-lg pt-5">
    ...
    <div><a href = "/rolItemsReport/PDF"  class ="btn btn-danger"   style = "float:right">Convert to PDF</a> </div><br><br>
    <br>
    ...
    <br>
    <a href="/reorderItems/reports" class="btn btn-primary">Back</a>
    <br>
    <br>
</div>
<!--Footer-->
