...
<head>
    ...
    <title>Search of In Maintenance Vehicles</title>
</head>
<body>
        ...
        <div class='row'>
            ...
            <table class="table table-dark">
                ...
                <tr>
                    ...
                    <td>{{$data->cost}}</td>
                    <td><a href="/editvehiclemaintenance/{{$data->maintenance_id}}" class="btn btn-success">Update</a></td>
    ...
    <div>
      <a href="/vehiclemaintenance" class="btn btn-primary" style = "float:left">Back</a>
     </div>
    </div>
</div>
</div>
