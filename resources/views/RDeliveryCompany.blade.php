...
<head>
    ...
    <title>Report | Delivery | Company</title>
</head>
<body>
...
<!--Tab Pane-->
    <div class="container">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link active {{request () -> is('/RCompany') ? 'active' : null }}" href="{{url('/RCompany')}}" role="tab">Delivery Report | Company Vehicles</a>
            </li>
            <li class="nav-item">
...
<div class="container">
  <h4>Select date range</h4><br>
        <form method="GET" action="/RCompanyFilter">
...
<div class="container">
    ...
    <div><a href = "/RCompany/pdf/{{$from_date}}/{{$to_date}}"  class ="btn btn-danger"   style = "float:right">Convert in to PDF</a> </div><br>
