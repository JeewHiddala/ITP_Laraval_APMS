...
<head>
    ...
    <title>Search of In Maintenance Machineries</title>
</head>
<body>
        ...
        <div class='row'>
            ...
            <table class="table table-dark">
                ...
                <tr>
                    ...
                    <td>{{$data->cost}}</td>
                    <td><a href="/editmachinerymaintenance/{{$data->maintenance_id}}" class="btn btn-success">Update</a></td>
    ...
    <div>
      <a href="/machinerymaintenance" class="btn btn-primary" style = "float:left">Back</a>
     </div>
    </div>
</div>
</div><br><br>
