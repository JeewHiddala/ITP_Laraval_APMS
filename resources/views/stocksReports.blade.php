...
<div class="container-lg pt-5">
    ...
    <div class="container">
        ...
        <form method="GET" action="/stocksReports">
    ...
    <div class="col-md-4 float-left">
        <form action="/search/items" method="GET">
            ...
            <div class="input-group">
                <input type="search" name="searchBar" placeholder="Item Number" class="form-control">
...
<div class="container-lg pt-5">
    <div><a href = "/stocksReports/PDF/{{$from_date}}/{{$to_date}}"  class ="btn btn-danger"   style = "float:right">Convert to PDF</a> </div><br><br>
