...
<head>
    ...
    <title>Report | Delivery | Courier</title>
</head>
<body>
...
<!--Tab Pane-->
    <div class="container">
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
                <a class="nav-link   {{request() -> is('/RDelivery') ? 'active' : null }}"  href="{{url('/RDelivery')}}" role="tab">Delivery Report</a>
            </li>
            <li class="nav-item">
                <a class="nav-link  {{request () -> is('/RCompany') ? 'active' : null }}" href="{{url('/RCompany')}}" role="tab">Delivery Report | Company Vehicles</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active {{request () -> is('/RCourier') ? 'active' : null }}" href="{{url('/RCourier')}}" role="tab">Delivery Report | Courier Services</a>
            </li>
            <li class="nav-item">
...
<div class="container">
  <h4>Select date range</h4><br>
        <form method="GET" action="/RCourierFilter">
...
<div class="container">
    ...
    <div><a href = "/RCourier/pdf/{{$from_date}}/{{$to_date}}"  class ="btn btn-danger"   style = "float:right">Convert in to PDF</a> </div><br>
