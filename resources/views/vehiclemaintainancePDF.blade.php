...
<!--Tab Pane-->
    <div class="container">
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
                <a class="nav-link active {{request() -> is('/vehiclemaintainancePDF') ? 'active' : null }}"  href="{{url('/vehiclemaintainancePDF')}}" role="tab">Vehicle Maintenance Report</a>
            </li>
            <li class="nav-item">
...
<div class="container">
  <h4>Select date range</h4><br>
        <form method="GET" action="/vehiclemaintainancedatepicker">
...
<div class="container">
    <div class="form-group">
      ...
      <div><a href = "/vehiclemaintainancePDF/pdf/{{$from_date}}/{{$to_date}}"  class ="btn btn-danger"   style = "float:right">Convert in to PDF</a> </div><br>
