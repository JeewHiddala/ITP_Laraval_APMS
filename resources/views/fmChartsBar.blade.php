...
<body>
    ...
    <h3>Select the type of chart you want</h3>
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
                <a class="nav-link  {{request() -> is('/fmCharts') ? 'active' : null }}" href="{{url('/fmCharts')}}"
                    role="tab">Pie Charts</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active {{request () -> is('/fmChartsBar') ? 'active' : null }}"
                        href="{{url('/fmChartsBar')}}" role="tab">Bar Charts</a>
                </li>
        ...
        <br>
            <div class="container">
                ...
                <form method="GET" action="/chartCategoryBar">
