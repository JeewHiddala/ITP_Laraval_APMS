            ...
            <div class="col-md-12">
                <form method="post" action="/feedback">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="feedback" placeholder="Feedback" id="fed" required><br>
                    </div><br>

                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                        Date  &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                        <input type="Date" class="form-control" name="date" placeholder="" id="date"><br>
                    </div>
                    <br>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="cusName" placeholder="Customer Name" id="cusname"><br>

                    </div>
                    <br>

                    </br>
                    <input type="submit" class="btn btn-primary" value="Add" id="btnres">
