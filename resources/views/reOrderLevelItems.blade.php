...
<nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav" >
    ...
    <div class="col-md-2 float-right">
        <form action="/reorderItemsSearch/rol" method="GET">
            {{csrf_field()}}
...
{{--<div class="col-md-12">--}}
    <h1 align="center">Items Reached Re-Order Level</h1>
    <br/>
...
<div class="input-group">
    ...
    <div style="margin-left: 20px" class="alert alert-warning" role="alert">
  <label style="font-size: 20px;">Number of Items reached ROL :  </label>
   &nbsp;&nbsp;&nbsp;
  <label id="total_rol_items" style="font-size: 20px;">{{count($stockItems)}}</label>
    </div>
</div>
<br>
