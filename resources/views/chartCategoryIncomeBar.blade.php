...
<html>
 <head>
    ...
    <title>Income Category Graph</title>
    ...
    <script type="text/javascript">
        ...
        function drawChart()
        {
            ...
            var options = {
            title : 'Frequency of Income Categories'
            };
...
<!--</header>-->
  ...
  <div class="container">   
   <div class="panel panel-default">
    <div class="panel-heading">
     <h3 class="panel-title">Frequency of Income Categories</h3>
    </div>
  ...
  <br>
    ...
    &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
     <a href="/fmChartsIncomeBar" class="btn btn-success">Back</a>
    <br>
    <br>
</body>
</html>