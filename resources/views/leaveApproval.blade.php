...
<head>
    ...
    <title>Leave Form Approval</title>
    <br>
</head>
<body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ">
              ...
              <li class="nav-item px-lg-4">
                <a class="nav-link text-uppercase text-expanded" href="/dynamicLeave_pdf">Report</a>
              </li>
            </ul>
...
<div class="container"> 
        ...
        <h1>Leave Form Approval</h1>

        <br>
    <div class="container">
    <ul class="nav nav-tabs" role="tablist">
	<li class="nav-item">
		<a class="nav-link active {{request () -> is('/approval') ? 'active' : null }}"  href="{{url('/approval')}}" role="tab">Leave Approval</a>
	</li>
	<li class="nav-item">
		<a class="nav-link {{request () -> is('/sapproval') ? 'active' : null }}" href="{{url('/sapproval')}}" role="tab">ShortLeave Approval</a>
	</li>
...
<br>
        ...
        <table class="table table-dark">
                    ...
                    <tr>
                     ...
                     @if(!$form->isApproved)
                        <a href="/markasapproved/{{$form->leave_id}}" class="btn btn-primary">Mark as approved</a>
                     @else
                        <a href="/markasnotapproved/{{$form->leave_id}}" class="btn btn-danger">Mark as rejected</a>
