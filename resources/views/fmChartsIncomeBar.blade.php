...
<body>
    ...
    <h3>Select the type of chart you want</h3>
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
                <a class="nav-link  {{request() -> is('/fmChartsIncome') ? 'active' : null }}" href="{{url('/fmChartsIncome')}}"
                    role="tab">Pie Charts</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active {{request () -> is('/fmChartsIncomeBar') ? 'active' : null }}"
                        href="{{url('/fmChartsIncomeBar')}}" role="tab">Bar Charts</a>
                </li>     
        </ul>
        ...
        <div class="container">
            ...
            <form method="GET" action="/chartsCategoryIncomeBar">
                <div class="form-group">
                    ...
                    <br>
                    <input type="submit" value="Draw Bar Chart" class="btn btn-success">
