...
<head>
    ...
    <title>Update | Deliver | Company Vehicles</title>
</head>
<body>
    ...
    <div class="container">
        <div class="form-group">
            ...
            <form method="post" action = "/updatedeliveries">
            {{csrf_field()}}
            ...
            <input type="date" class = "date form-control" value="{{$data->date}}" name="date" placeholder = ""/><br>
            <p style="text-align:left">Total</p>
            <input type="number" class = "total form-control" value="{{$data->total}}" name="total" placeholder = ""/><br>
            <input  type="submit" class="btn btn-primary" value="Save" onclick="return confirm('Are you sure you want to update?')"/>&nbsp;&nbsp;
            <a href="/deliver1"  class="btn btn-danger" >Cancel</a>
            </form>
