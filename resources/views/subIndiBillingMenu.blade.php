...
<head>
    ...
    <title>Order Placement Individual Customers</title>
...
<div class="container-lg pt-5">
    <h1>Order Managment - Individual Customers</h1>
    <br>
    <br>
</div>
    ...
    <div class="card-deck">
        <div class="card" style="width:400px;">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Bill Placement for Individual Customers</p>
                <a href="/bills" class="btn btn-primary">Let's go..</a>
            </div>
        </div>
        ...
        <div class="card" style="width:400px;">
            ...
            <div class="card-body">
                <h4 class="card-title">Unavaible Items</h4>
                <p class="card-text">Maintain the records of unavailable items</p>
                <a href="/unavailableItems" class="btn btn-primary">Enter</a>
            </div>
        </div>
    </div>
    <br>
