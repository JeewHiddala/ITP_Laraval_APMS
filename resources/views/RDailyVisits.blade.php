...
<head>
    ...
    <title>Report | Daily Vists</title>
</head>
<body>
...
<!--Tab Pane-->
    <div class="container">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link active {{request () -> is('/RVisits') ? 'active' : null }}" href="{{url('/RVisits')}}" role="tab">Company Visits</a>
            </li>
...
<div class="container">
    <h4>Select date range</h4><br>
        <form method="GET" action="/RVisitsFilter">
...
<div class="container">
    ...
    <div><a href = "/RVisit/pdf/{{$from_date}}/{{$to_date}}"  class ="btn btn-danger"   style = "float:right">Convert in to PDF</a> </div><br>
