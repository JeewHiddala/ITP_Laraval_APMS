...
<body>
<img src="{{ URL::asset('images/logo.png') }}" alt="logo" width="110" height="100" style="float:left; margin-top:-2.2% ;padding-left:0.5%">
...
<div class="container-sm pt-3">
    <div class="card-deck">
        <div class="card" style="height:21rem; width: 15rem;">
            <img class="card-img-top" src="{{ URL::asset('images/expense.png') }}" alt="Card image" style="width:150px; height:150px; margin-right:auto; margin-left:auto; ">
            <div class="card-body">
        ...
        <div class="card" style="height:21rem; width: 15rem;">
            <img class="card-img-top" src="{{ URL::asset('images/summary.png') }}" alt="Card image" style="width:150px; height:150px; margin-right:auto; margin-left:auto; ">
            <div class="card-body">
        ...
        <div class="card" style="height:21rem; width: 15rem;">
            <img class="card-img-top" src="{{ URL::asset('images/product.png') }}" alt="Card image" style="width:150px; height:150px; margin-right:auto; margin-left:auto; ">
            <div class="card-body">
        ...
        <div class="card" style="height:21rem; width: 15rem;">
            <img class="card-img-top" src="{{ URL::asset('images/notepad.png') }}" alt="Card image" style="width:150px; height:150px; margin-right:auto; margin-left:auto; ">
            <div class="card-body">
        ...
        <div class="card" style="height:21rem; width: 15rem;">
            <img class="card-img-top" src="{{ URL::asset('images/package.png') }}" alt="Card image" style="width:150px; height:150px; margin-right:auto; margin-left:auto; ">
            <div class="card-body">
