...
<head>
    ...
    <title>Supplier and WholeSale Buyer Management</title>
...
<img src="images/logo.png" alt="logo" width="110" height="100" style="float:left; margin-top:-2.2% ;padding-left:0.5%">
    ...
    <div class="container-lg pt-5">
        <h1>Supplier and WholeSale Buyer Management</h1>
        <br>
        <br>
    </div>
    <div class="container-sm pt-3">
        <div class="card-deck">
            <div class="card" style="height:21rem; width:15rem;">
                ...
                <div class="card-body">
                    <center><h4 class="card-title">Supplier Managment</h4></center>
                   <center> <p class="card-text">Manage local and foreign suppliers</p></center><br>
                   <center> <a href="/supplierHome" class="btn btn-primary">Enter</a></center>
                </div>
            </div>
           
            <div class="card" style="height:21rem; width:15rem;">
                <img class="card-img-top" src="images/wholeBuyers.png" alt="Card image" style="width:150px; height:150px; margin-right:auto; margin-left:auto; ">
                <div class="card-body">
                    <center><h4 class="card-title">WholeSale Buyer Managment</h4></center>
                    <center> <p class="card-text">Manage wholesale buyers..</p></center><br>
                    <center> <a href="/buyerHome" class="btn btn-primary">Enter</a></center>
                </div>
            </div>
        </div>
        <br>
