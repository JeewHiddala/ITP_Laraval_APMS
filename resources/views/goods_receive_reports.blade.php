...
<div class="container-lg pt-5">
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link active {{request() -> is('/goodsReceiveReports') ? 'active' : null }}" href="{{url('/goodsReceiveReports')}}"
    ...
    <div class="container">
        ...
        <form method="GET" action="/goodsReceiveReports">
...
<div class="container-lg pt-5">
    <div><a href = "/goodsReceiveReports/PDF/{{$from_date}}/{{$to_date}}"  class ="btn btn-danger"   style = "float:right">Convert to PDF</a> </div><br><br>
    ...
    <br>
    <a href="/goodsReceiveReports" class="btn btn-primary">Back</a>
    <br>
    <br>
</div>
<!--Footer-->
