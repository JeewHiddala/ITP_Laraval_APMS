...
<p> Date and Time : '.$date.'</p><br>
  <h3 align="center">Bill Report </h3>
  <br>
  <table style="border-collapse:collapse; border: 0px;">

<tr>
    <th style="border: 1px solid; padding:12px;" width="20%">Invoice No.</th>
    <th style="border: 1px solid; padding:12px;" width="30%">Grand Total</th>
    <th style="border: 1px solid; padding:12px;" width="15%">Client</th>
    <th style="border: 1px solid; padding:12px;" width="15%">Invoice Date</th>
    <th style="border: 1px solid; padding:12px;" width="20%">Due Date</th>
    <th style="border: 1px solid; padding:12px;" width="20%">Created At</th>
        ...
        foreach($customer_data as $customer)
        {
            $output .= '
      <tr>
       <td style="border: 1px solid; padding:12px;">'.$customer->invoice_no.'</td>
       <td style="border: 1px solid; padding:12px;">'.$customer->grand_total.'</td>
       <td style="border: 1px solid; padding:12px;">'.$customer->client.'</td>
       <td style="border: 1px solid; padding:12px;">'.$customer->invoice_date.'</td>
       <td style="border: 1px solid; padding:12px;">'.$customer->due_date.'</td>
